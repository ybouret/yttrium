...
#include "p16.hxx"
        ...
        const uint32_t Prime:: Pi2ToThe[37] =
        {
            0,            //!< <= 2^0
            1,            //!< <= 2^1
            2,            //!< <= 2^2
            ...
            1480206279,   //!< <= 2^35
            2874398515    //!< <= 2^36
            //, 5586502348, 10866266172, 21151907950, 41203088796
            //, 80316571436, 156661034233, 305761713237,
            // 597116381732, 1166746786182, 2280998753949,
            // 4461632979717, 8731188863470, 17094432576778, 33483379603407, 65612899915304, 128625503610475
        };
