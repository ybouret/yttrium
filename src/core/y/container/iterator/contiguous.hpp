...
namespace Yttrium
{
    ...
    template <typename T>
    class ContiguousWritable : public ContiguousReadable<T>
    {
    public:
        Y_ARGS_EXPOSE(T,Type); //!< aliases
    ...
    public:
        ...
        inline Iterator begin() noexcept { return Iterator( (MutableType *)(this->getBaseForward()) ); }
        inline Iterator end()   noexcept { return Iterator( (MutableType *)(this->getLastForward()) ); }
