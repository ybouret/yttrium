...
#ifndef Y_Oversized_Included
#define Y_Oversized_Included 1
...
namespace Yttrium
{
    ...
    //
    //
    //! base class for oversized objects
    //
    //
    //__________________________________________________________________________
    class Oversized
    ...
    public:
        ...
        //
        //______________________________________________________________________
        virtual ~Oversized() noexcept;
        explicit Oversized() noexcept;
    ...
    private:
        Y_DISABLE_COPY_AND_ASSIGN(Oversized);
    };
