...
namespace Yttrium
{
    ...
    namespace GraphViz
    {
        ...
        public:
            ...
            static String        Color(const String &scheme, size_t indx);                      //!< format \"/schemeXX/indx\" or \"indx\"
            static String        Color(const char   *scheme, size_t indx);                      //!< format \"/schemeXX/indx\" or \"indx\"
