...
\begin{equation}
	\partial_t C_i = \sigma_i -\dfrac{1}{L} \left[ \hat J_{i+}- \hat J_{i-} \right] - \dfrac{1}{L}  \left[ z_i D_i (C_{i+} \eta_+ - C_{i-} \eta_-) \right] = F_i - \dfrac{1}{L}  \left[ z_i D_i (C_{i+} \eta_+ - C_{i-} \eta_-) \right]
\end{equation}


\begin{equation}
	\sum_i z_i C_i = 0 \implies  = L \langle \vec Z \vert \vec F \rangle
