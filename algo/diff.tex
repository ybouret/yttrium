...
\begin{equation}
	\partial_t \vec C = \vec F + \vec \Psi
\end{equation}

\begin{equation}
	\Delta \partial_t \zeta = -\kappa_\rho \partial_t \rho = \langle \vec Z \vert  \vec F \rangle + \langle \vec Z \vert  \vec \Psi \rangle
\end{equation}	
...
\begin{equation}
	\vec \phi_i = z_i D_i C_i \vec \eta(t) = z_i D_i (C_i + F_i \times t + \int \Psi_i dt) \vec \eta (t)
\end{equation}
