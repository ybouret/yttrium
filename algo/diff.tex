...
\begin{equation}
	C_i(\vec{r},t+\delta t) \simeq C_i(\vec{r},t+\delta t) + \delta C_i(\vec{r},t),\;\; \delta C_i = -\delta t \mathrm{div}\vec{J}_i
\end{equation}

\begin{equation}
	\delta \rho(\vec{r},t+\delta t) = \sum_i z_i \delta{C}_i(\vec{r},t)
\end{equation}

\begin{equation}
	\Delta \zeta = -\kappa_\rho \delta \rho(\vec{r},t+\delta t) 
\end{equation}
...
\begin{equation}
	\vec{\phi}_i = D_i z_i C_i(\vec{r},t+\delta t) \vec{\eta}
\end{equation}

\begin{equation}
	\delta C_i' = - \delta t \mathrm{div} \vec{\phi}_i 
	=  \delta t D_i z_i \left[ C_i(\vec{r},t+\delta t) \mathrm{div}\vec{\eta} + \vec\eta \cdot \vec\nabla C_i(\vec{r},t+\delta t)\right]
\end{equation}

\begin{equation}
	0 = \sum_i z_i \delta C_i + \sum_i z_i \delta C_i'
\end{equation}
