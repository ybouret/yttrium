...
\begin{equation}
	\mathrm{div}{\vec{J}_i} = -D_i \Delta C_i + \mathrm{div} \vec{\phi}_i
\end{equation}

Steady State:
\begin{equation}
	\Delta C_i = \frac{1}{D_i} \mathrm{div} \vec{\phi}_i \implies \sum_i \dfrac{z_i}{D_i} \mathrm{div} \vec{\phi}_i = 0
\end{equation}

\end{document}

\begin{equation}
	\vec{J}_i = -D_i \vec{\nabla} C + z_i C_i D_i \vec{\eta}
\end{equation}
	
\begin{equation}
	\sum_i z_i \vec{J}_i = -\left(\sum_i z_i D_i \vec{\nabla}C\right) + \left( \sum_i z_i^2 C_i D_i\right) \vec{\eta}
\end{equation}

\begin{equation}
	\partial_t \rho = 0 \iff  \vec{\phi}_0 = -\left(\sum_i z_i D_i \vec{\nabla}C_i\right) + \left( \sum_i z_i^2 C_i D_i\right) \vec{\eta}
\end{equation}

\begin{equation}
	\vec{\eta} = \left[\sum_i z_i^2 C_i D_i\right]^{-1}\left[\vec{\phi}_0+\sum_i z_i D_i \vec{\nabla}C_i\right]
\end{equation}
