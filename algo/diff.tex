...
\begin{equation}
	\partial_t C_i' = -\mathrm{div} \vec \phi_i
\end{equation}

\begin{equation}
\begin{array}{rcl}
	\partial_t C_i' & = & -z_i D_i \left[ C_i(t) \mathrm{div} \vec\eta(t) + \vec\eta(t) \cdot \vec\nabla C_i(t)\right]\\
	 & = & -z_i D_i\left[ C_i(t) \kappa_\rho \rho(t) + \vec\eta(t) \cdot \vec\nabla C_i(t) \right]\\
\end{array}
\end{equation}

We must achieve:
\begin{equation}
	\partial_t \rho + \langle \vec Z \vert \partial_t \vec C' \rangle = 0
\end{equation}
