...
\begin{equation}
	\vec C^{n+1}  \simeq  \vec C^{n} + \tau \vec F(\vec C^{n+1})
\end{equation}

\begin{equation}
[\vec C^{n+1}  -  \vec C^{n}] \simeq \tau \vec F(\vec C^n + ([ \vec C^{n+1}-\vec C^{n} ]) 
\simeq \tau \left( \vec F(\vec C^n) +   \partial_{\vec C} \vec F_n \vert [ \vec C^{n+1}-\vec C^{n} ] \rangle \right)
\end{equation}

\begin{equation}
	\left[\bm{I} - \tau \cdot \partial_{\vec C} \vec F_n \right] [\vec C^{n+1}  -  \vec C^{n}] \simeq \tau \vec F(\vec C^n)
\end{equation}

\begin{equation}
	\vec C^{n+1} \simeq \vec C^n + \tau \left[\bm{I}_M - \tau \cdot \partial_{\vec C} \vec F_n \right]^{-1} \vec F(\vec C^n)
\end{equation}
