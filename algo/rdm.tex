...
\begin{equation}
	\delta \vec C = \dfrac{\langle \delta \vec C \vert \vec \nu _i \rangle}{\vec \nu _i^2} \vec \nu_i 
	+ \left( \delta \vec C - \dfrac{\langle \delta \vec C \vert \vec \nu _i \rangle}{\vec \nu _i^2} \vec \nu_i \right)
	= \alpha_i \vec \nu_i + \left(\delta \vec C - \alpha_i \vec\nu_i\right)
\end{equation}

\begin{equation}
	\Xi_i(\vec C_0 + \delta \vec C) =
	 \Xi_i \left( \vec C_0 + \alpha_i \vec \nu_i + \left( \delta \vec C - \alpha_i \vec \nu_i\right) \right)
\end{equation}

\begin{equation}
	\Xi_i(\vec C_0 + \delta \vec C) \simeq \Xi_i \left( \vec C_0 + \alpha_i \vec \nu_i  \right) 
	+ \langle  \vec \Psi_{\alpha_i} \vert \left( \delta \vec C - \alpha_i \vec \nu_i\right)\rangle
\end{equation}
...
\begin{equation}
	\langle \vec \alpha \vert \vec C \rangle \leq 0
\end{equation}
