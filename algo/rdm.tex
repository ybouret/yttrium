...
\begin{array}{rcl}
	...
	& \simeq & \sigma_i (\xi_i-\xi_i^\star) + \beta_i (\xi_i - \xi_i^\star)^2 + \sum_{j\not=i} \langle \vec \Psi_{\xi_i} \vert \vec \nu_j \rangle \xi_j\\
\end{array}
\end{equation}
...
\left\lbrace
\begin{array}{rcl}
	f_i(\xi_i) & = & \sigma_i (\xi_i-\xi_i^\star) + \beta_i (\xi_i - \xi_i^\star)^2\\
	\beta_i {\xi_i^\star}^2 & = &  \Xi_i + \sigma_i \xi_i^\star \\
	f_i(0) & = & \Xi_i\\
	f_i(\xi_i^\star) & = & 0\\
\end{array}
\right.
...
There is one unique solution to
\begin{equation}
	f_i(\xi_i) = \lambda \Xi_i, \; \xi_i\in[0,\xi_i^\star], \lambda \in[0:1]
\end{equation}
	
\begin{equation}
f_i(\xi_i) - \lambda \Xi_i = \beta_i \xi_i^2 
+ \xi_i \left( \sigma_i - 2\beta_i \xi_i^\star\right) 
+ \underbrace{\beta_i {\xi_i^\star}^2 - \sigma_i \xi_i^\star- \lambda \Xi_i}_{(1-\lambda)\Xi_i}
\end{equation}
